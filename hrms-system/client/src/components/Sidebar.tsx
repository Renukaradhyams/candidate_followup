...
export default function Sidebar({ session, isOpen, onClose }: SidebarProps) {
  ...
  const roleNavMap: Record<string, string[]> = {
    'Super Admin': ['dashboard', 'candidates', 'interview', 'offer', 'openings', 'onboarding', 'employees', 'joined_store', 'joining_call_desk', 'doj_planning', 'workforce_analytics', 'dept_hiring', 'section_allocation', 'exit', 'form', 'settings', 'broadcast'],
    'Admin':       ['dashboard', 'candidates', 'interview', 'offer', 'openings', 'onboarding', 'employees', 'joined_store', 'joining_call_desk', 'doj_planning', 'workforce_analytics', 'dept_hiring', 'section_allocation', 'exit', 'form', 'settings', 'broadcast'],
    'HR':          ['dashboard', 'candidates', 'interview', 'offer', 'openings', 'onboarding', 'employees', 'joined_store', 'joining_call_desk', 'doj_planning', 'workforce_analytics', 'dept_hiring', 'section_allocation', 'exit', 'form', 'broadcast'],
    'Recruiter':   ['dashboard', 'candidates', 'interview', 'form', 'broadcast'],
    'Interviewer': ['interview', 'candidates'],
    'Manager':     ['dashboard', 'candidates', 'interview', 'offer', 'openings', 'employees', 'joined_store', 'joining_call_desk', 'doj_planning', 'workforce_analytics', 'dept_hiring', 'section_allocation', 'broadcast'],
    ...
    API.getPageSettings().then(res => {
      ...
      if (settingsObj && Object.keys(settingsObj).length > 0) {
        const allKeys = [
          ...
          'onboarding', 'employees', 'joined_store', 'joining_call_desk', 'doj_planning', 'workforce_analytics', 'dept_hiring', 'section_allocation', 
