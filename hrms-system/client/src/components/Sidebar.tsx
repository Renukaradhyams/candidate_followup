...
export default function Sidebar({ session, isOpen, onClose }: SidebarProps) {
  ...
  const roleNavMap: Record<string, string[]> = {
    'Super Admin': ['dashboard', 'candidates', 'interview', 'offer', 'openings', 'onboarding', 'employees', 'joined_store', 'employee_master', 'joining_call_desk', 'not_joined', 'doj_planning', 'workforce_analytics', 'dept_hiring', 'section_allocation', 'batch_plan', 'batch_attendance', 'exit', 'form', 'settings', 'broadcast'],
    'Admin':       ['dashboard', 'candidates', 'interview', 'offer', 'openings', 'onboarding', 'employees', 'joined_store', 'employee_master', 'joining_call_desk', 'not_joined', 'doj_planning', 'workforce_analytics', 'dept_hiring', 'section_allocation', 'batch_plan', 'batch_attendance', 'exit', 'form', 'settings', 'broadcast'],
    'HR':          ['dashboard', 'candidates', 'interview', 'offer', 'openings', 'onboarding', 'employees', 'joined_store', 'employee_master', 'joining_call_desk', 'not_joined', 'doj_planning', 'workforce_analytics', 'dept_hiring', 'section_allocation', 'batch_plan', 'batch_attendance', 'exit', 'form', 'broadcast'],
    'Recruiter':   ['dashboard', 'candidates', 'interview', 'form', 'broadcast'],
    'Interviewer': ['interview', 'candidates'],
    'Manager':     ['dashboard', 'candidates', 'interview', 'offer', 'openings', 'employees', 'joined_store', 'employee_master', 'joining_call_desk', 'not_joined', 'doj_planning', 'workforce_analytics', 'dept_hiring', 'section_allocation', 'batch_plan', 'batch_attendance', 'broadcast'],
    'Batch Leader': ['batch_plan', 'batch_attendance'],
    ...
    API.getPageSettings().then(res => {
      ...
      if (settingsObj && Object.keys(settingsObj).length > 0) {
        const allKeys = [
          ...
          'onboarding', 'employees', 'joined_store', 'employee_master', 'joining_call_desk', 'not_joined', 'doj_planning', 'workforce_analytics', 'dept_hiring', 'section_allocation', 'batch_plan', 'batch_attendance',
  ...
  const navItems = [
    ...
    { key: 'batch_attendance', href: '/batch-attendance', label: 'Batch Attendance (20-Day)', icon: CheckSquare, section: 'Talent Management' },
