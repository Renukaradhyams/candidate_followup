...
export const API = {
  ...
  async deleteBatch(id: number | string) { return apiFetch(`/batch-plan/batches/${id}`, { method: 'DELETE' }); },
  ...
  async deleteGroup(id: number | string) { return apiFetch(`/batch-plan/groups/${id}`, { method: 'DELETE' }); },
